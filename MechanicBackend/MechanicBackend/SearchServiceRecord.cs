...
{
    public partial class SearchServiceRecord : Form
    {
        private SqlConnection connection;

        public SearchServiceRecord(SqlConnection connection)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string searchQuery = "SELECT * FROM dbo.serviceRecord WHERE recordId = @id";
