...
{
    public partial class SearchMechanic : Form
    {
        private SqlConnection connection;

        public SearchMechanic(SqlConnection connection)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string searchQuery = "SELECT * FROM dbo.mechanic WHERE firstName = @name";
